        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <div class="mt-4 sm:mt-2 sm:ml-16 sm:flex-none">
                    <a href="{{route('domains.create')}}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add Domain</a>
                </div>
        </div>
                ...
                <div class="inline-block min-w-full py-2 align-middle">
                    ...
                    <div class="shadow-sm ring-1 ring-black ring-opacity-5">
                        <table class="min-w-full border-separate" style="border-spacing: 0">
                            ...
                            <tr>
                                <th scope="col" class="sticky top-0 z-10 border-b border-gray-300 bg-gray-50 bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">Domain</th>
                            ...
                            @foreach($domains as $domain)
                                ...
                                <tr>
                                    <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 lg:pl-8">{{$domain->name}}</td>
                                    <td class="relative whitespace-nowrap border-b border-gray-200 py-4 pr-4 pl-3 text-right text-sm font-medium sm:pr-6 lg:pr-8">
                                        <div class="sm:flex sm:items-center">
                                            <div class="sm:flex-auto">
                                                    <a href="{{route('domains.edit', $domain->id)}}" class="text-indigo-600 hover:text-indigo-900 mr-2">Edit</a>
                                            </div>
                                                <form action="{{route('domains.destroy', $domain->id)}}" method="post" onsubmit="return confirm('Are u sure to delete Domain?')">
                                                    @csrf
                                                    @method('DELETE')
