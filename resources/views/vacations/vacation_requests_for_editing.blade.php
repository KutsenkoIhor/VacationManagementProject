...
@section('content')
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <p class="mt-2 text-lg text-gray-800">Vacation requests to edit or cancel.</p>
                                                ...
                                                <form class="space-y-8 divide-y divide-gray-200">
                                                    ...
                                                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                                        <div class="sm:col-span-2">
                                                            ...
                                                            <label id="email" for="email" class="block text-sm font-medium text-gray-700">Email</label>{{$vacationRequest->getUser()->getEmail()}}
                                                            ...
                                                            <select id="edit_type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
